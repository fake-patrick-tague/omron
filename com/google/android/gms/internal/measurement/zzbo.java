...
{
  private static final ClassLoader thisClassLoader = zzbo.class.getClassLoader();
  ...
  public static void get(Parcel paramParcel, Parcelable paramParcelable)
  {
  ...
  public static HashMap getIdentities(Parcel paramParcel)
  {
    return paramParcel.readHashMap(thisClassLoader);
  }
  
  public static void newSession(Parcel paramParcel, IInterface paramIInterface)
  {
  ...
  public static void writeString(Parcel paramParcel)
  {
