...
public final class zzad
  extends zzj<zzbu>
{
  private static final com.google.android.gms.common.api.Api.ClientKey<zzad> CLIENT_KEY;
  public static final Api<Api.ApiOptions.NoOptions> FIXED;
  private static final zzf.zza zzoy = zzf.zza.zzbl;
  ...
  static
  {
    ...
    FIXED = new Attribute("Fitness.API", new zzaf(null), localClientKey);
    zzoz = new Attribute("Fitness.CLIENT", new zzah(null), localClientKey);
  }
  
  private zzad(Context paramContext, Looper paramLooper, ClientSettings paramClientSettings, GoogleApiClient.ConnectionCallbacks paramConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener paramOnConnectionFailedListener)
  {
