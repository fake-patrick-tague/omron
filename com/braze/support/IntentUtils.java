...
public final class IntentUtils
{
  ...
  private static final g random$delegate = h.a(LazyThreadSafetyMode.d, b.ABSOLUTE);
  ...
  public static final void addComponentAndSendBroadcast(Context paramContext, Intent paramIntent)
  {
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, INSTANCE, BrazeLogger.Priority.$EnumSwitchMapping$0, null, new a((ComponentName)localObject2, localIntent), 2, null);
    }
  }
    ...
    implements a<String>
  {
    ...
    public final String substring()
    {
      ...
      localStringBuilder.append(val$component);
  ...
  static final class b
    ...
    implements a<Random>
  {
    public static final b ABSOLUTE = new b();
