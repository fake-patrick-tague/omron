  ...
  implements IPutIntoJson<JSONObject>
{
  ...
  public JSONObject forJsonPut()
  {
    ...
    try
    {
      ...
      localJSONObject.put("enabled", bool);
      localObject = properties;
      localJSONObject.put("properties", localObject);
      return localJSONObject;
    }
    catch (JSONException localJSONException)
    {
      BrazeLogger.INSTANCE.brazelog(this, BrazeLogger.Priority.this$0, localJSONException, c.SingleTap);
    }
    return localJSONObject;
  }
