  ...
  extends BroadcastReceiver
{
  ...
  public static final class Companion
  {
    ...
    private final void handlePush(Context paramContext, final Intent paramIntent)
    {
      ...
      {
        BrazeLogger.INSTANCE.brazelog(this, BrazeLogger.Priority.this$0, paramContext, new j(str)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
            localStringBuilder.append("Caught exception while performing the push notification handling work. Action: ");
            localStringBuilder.append(BrazePushReceiver.Companion.this);
    ...
    private static final void handlePush$performWork(String paramString, Context paramContext1, Intent paramIntent, Context paramContext2)
    {
      ...
      BrazeLogger.brazelog$default(localBrazeLogger, localCompanion, BrazeLogger.Priority.g, null, new j(paramIntent)
      {
        public final String invoke()
        {
          StringBuilder localStringBuilder = new StringBuilder();
      ...
      if (i != 0)
      {
        BrazeLogger.brazelog$default(localBrazeLogger, localCompanion, BrazeLogger.Priority.PREPARED, null, new j(paramIntent)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
      ...
      case 34673601: 
        if ((goto 370) || (!paramString.equals("com.braze.action.BRAZE_STORY_CLICKED"))) {
          break label370;
        }
      ...
      case -743092218: 
        if ((goto 370) || (!paramString.equals("com.amazon.device.messaging.intent.REGISTRATION"))) {
          break label370;
        }
      ...
      label370:
      BrazeLogger.brazelog$default(localBrazeLogger, localCompanion, BrazeLogger.Priority.PREPARED, null, handlePush.performWork.3.INSTANCE, 2, null);
    }
    ...
    public final boolean handleAdmRegistrationEventIfEnabled(BrazeConfigurationProvider paramBrazeConfigurationProvider, Context paramContext, Intent paramIntent)
    {
      ...
      i.e(paramIntent, "intent");
      BrazeLogger localBrazeLogger = BrazeLogger.INSTANCE;
      BrazeLogger.brazelog$default(localBrazeLogger, this, BrazeLogger.Priority.g, null, new j(paramIntent)
      {
        public final String invoke()
        {
          StringBuilder localStringBuilder = new StringBuilder();
      ...
      BrazeLogger.brazelog$default(localBrazeLogger, this, BrazeLogger.Priority.PREPARED, null, handleAdmRegistrationEventIfEnabled.3.INSTANCE, 2, null);
      return false;
    }
    ...
    public final boolean handleAdmRegistrationIntent(Context paramContext, Intent paramIntent)
    {
      ...
      if (str1 != null)
      {
        BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, this, BrazeLogger.Priority.PREPARED, null, new j(str1)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
      ...
      {
        BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, this, BrazeLogger.Priority.g, null, new j(str3)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
      ...
      else
      {
        ...
        BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, this, BrazeLogger.Priority.PREPARED, null, new j(paramIntent)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
      ...
      return true;
      label145:
      BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, this, BrazeLogger.Priority.PREPARED, null, handleAdmRegistrationIntent.4.INSTANCE, 2, null);
      return false;
    }
    ...
    public final boolean handlePushNotificationPayload(Context paramContext, Intent paramIntent)
    {
      ...
      if (i.a("deleted_messages", paramIntent.getStringExtra("message_type")))
      {
        ...
        BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, this, BrazeLogger.Priority.g, null, new j(i)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
      ...
      BrazeLogger localBrazeLogger = BrazeLogger.INSTANCE;
      Object localObject2 = BrazeLogger.Priority.g;
      ...
      if (BrazeNotificationUtils.isNotificationMessage(paramIntent))
      {
        ...
        BrazeLogger.brazelog$default(localBrazeLogger, this, BrazeLogger.Priority.$EnumSwitchMapping$0, null, new j((BrazeNotificationPayload)localObject1)
        {
          public final String invoke()
          {
            StringBuilder localStringBuilder = new StringBuilder();
      ...
      for (;;)
      {
        ...
        BrazeLogger.brazelog$default(localBrazeLogger, this, null, null, new j((NotificationManagerCompat)localObject2)
        {
          public final String invoke()
          {
            ...
            localStringBuilder.append(areNotificationsEnabled());
            return localStringBuilder.toString();
          }
        }, 3, null);
    ...
    public final void handleReceivedIntent(Context paramContext, final Intent paramIntent, boolean paramBoolean)
    {
      ...
      if (paramBoolean)
      {
        h.d(BrazeCoroutineScope.INSTANCE, null, null, new l(paramContext, paramIntent)
        {
          ...
          {
            return (d)new 1(BrazePushReceiver.Companion.this, paramIntent, paramAnonymousD);
          }
