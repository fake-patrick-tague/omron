...
{
  private static final String NOTIFICATION_URI = BrazeLogger.getBrazeLogTag(TextAnnouncementCardView.class);
  ...
  public void onSetCard(TextAnnouncementCard paramTextAnnouncementCard)
  {
    ...
    setOnClickListener(new NumberPicker(this, paramTextAnnouncementCard));
  }
}
