  ...
  extends InAppMessageImmersiveBaseView
{
  ...
  public void resetMessageMargins(boolean paramBoolean)
  {
    ...
    if (localObject != null) {
      ((View)localObject).setOnClickListener(new NoteEditor.4(this));
    }
  }
  ...
  protected void resizeGraphicFrameIfAppropriate(Context paramContext, InAppMessageModal paramInAppMessageModal)
  {
    ...
    if (paramInAppMessageModal != null)
    {
      ...
      post(new b(this, paramContext.getDimensionPixelSize(R.dimen.com_braze_inappmessage_modal_margin), paramContext.getDimensionPixelSize(R.dimen.com_braze_inappmessage_modal_max_width), paramContext.getDimensionPixelSize(R.dimen.com_braze_inappmessage_modal_max_height), d));
    }
  }
