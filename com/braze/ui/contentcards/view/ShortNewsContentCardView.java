  ...
  extends BaseContentCardView<ShortNewsCard>
{
    ...
    extends ContentCardViewHolder
  {
    ...
    public ViewHolder(View paramView)
    {
      ...
      title = ((TextView)paramView.findViewById(R.id.com_braze_content_cards_short_news_card_title));
      description = ((TextView)paramView.findViewById(R.id.com_braze_content_cards_short_news_card_description));
      imageView = ((ImageView)paramView.findViewById(R.id.com_braze_content_cards_short_news_card_image));
    }
