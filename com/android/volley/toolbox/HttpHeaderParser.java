...
public class HttpHeaderParser
{
  ...
  static List combineHeaders(List paramList, Cache.Entry paramEntry)
  {
  ...
  static Map getCacheHeaders(Cache.Entry paramEntry)
  {
    if (paramEntry == null) {
  ...
  static List toAllHeaderList(Map paramMap)
  {
  ...
  static Map toHeaderMap(List paramList)
  {
