  ...
  implements HttpStack
{
  ...
  static HttpUriRequest createHttpRequest(Request paramRequest, Map paramMap)
    throws AuthFailureError
  {
    ...
    case 7: 
      ...
      return (HttpUriRequest)paramMap;
    case 6: 
  ...
  private static List getPostParameterPairs(Map paramMap)
  {
  ...
  private static void setHeaders(HttpUriRequest paramHttpUriRequest, Map paramMap)
  {
    Iterator localIterator = paramMap.keySet().iterator();
    while (localIterator.hasNext())
    {
